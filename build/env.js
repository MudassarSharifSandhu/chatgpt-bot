...
dotenv.config();
export const { DATA_PATH, KEYV_BACKEND, KEYV_URL, KEYV_BOT_STORAGE, 
/** Matrix Bot Settings */
MATRIX_HOMESERVER_URL, MATRIX_ACCESS_TOKEN, MATRIX_BOT_USERNAME, MATRIX_BOT_PASSWORD, 
/** Matrix Bot Features */
MATRIX_AUTOJOIN, MATRIX_ENCRYPTION, MATRIX_THREADS, MATRIX_PREFIX_DM, MATRIX_RICH_TEXT, MATRIX_WELCOME, 
/** Matrix Access Control */
MATRIX_BLACKLIST, MATRIX_WHITELIST, MATRIX_ROOM_BLACKLIST, MATRIX_ROOM_WHITELIST, 
/** Matrix Bot Runtime Config */
MATRIX_DEFAULT_PREFIX, MATRIX_DEFAULT_PREFIX_REPLY, 
/** ChatGPT Settings */
OPENAI_AZURE, OPENAI_API_KEY, CHATGPT_CONTEXT, CHATGPT_TIMEOUT, CHATGPT_API_MODEL, CHATGPT_PROMPT_PREFIX, CHATGPT_IGNORE_MEDIA, CHATGPT_REVERSE_PROXY, CHATGPT_TEMPERATURE, } = parseEnv(process.env, {
